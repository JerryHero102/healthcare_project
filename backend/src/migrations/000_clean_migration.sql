-- ============================================
-- CLEAN DATABASE MIGRATION - NO SAMPLE DATA
-- Author: Healthcare Management System
-- Date: 2025-11-19
-- Description: Clean schema only, no sample data (except default accounts)
-- ============================================

\echo '============================================'
\echo 'CLEAN MIGRATION - Starting...'
...
-- Table: infor_users (KHÔNG CÓ employee_id constraint vì có thể null)
...
-- Table: infor_auth_employee (Legacy auth table - optional)
...
CREATE TRIGGER update_medical_info_updated_at BEFORE UPDATE ON user_medical_info FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- ============================================
-- STEP 7: Insert ONLY Essential Default Data
-- ============================================
\echo 'Step 7: Inserting essential default data...'

-- Insert Departments (REQUIRED for foreign keys)
...
-- Insert Positions (REQUIRED for foreign keys)
...
-- Insert Default Accounts (REQUIRED for login)
...
\echo 'Essential default data inserted successfully.'
\echo ''
...
\echo ''
\echo '============================================'
\echo 'Database is ready! NO sample data inserted.'
\echo 'Tables: 16'
\echo 'Departments: 10'
\echo 'Positions: 10'
\echo 'Accounts: 5'
...
\echo '  admin / admin123'
\echo '  doctor01 / doctor123'
\echo '  nurse01 / nurse123'
\echo '============================================'
